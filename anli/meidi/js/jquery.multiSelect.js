...
if(jQuery) (function($){
  ...
  $.extend($.fn, {
    multiSelect: function(o, callback) {
      ...
      if( o.noneSelected == undefined ) o.noneSelected = '璇烽€夋嫨浜у搧';
      if( o.oneOrMoreSelected == undefined ) o.oneOrMoreSelected = '宸查€�%绉嶄骇鍝�';
      ...
      $(this).each( function() {
        ...
        if( o.selectAll ) html += '<label style="width:200px;text-align:left;" class="selectAll"><input style="width:10px;" type="checkbox" class="selectAll" />' + o.selectAllText + '</label>';
        $(select).find('OPTION').each( function() {
          if( $(this).val() != '' ) {
            html += '<label style="width:200px;text-align:left;"><input style="width:10px;" type="checkbox" name="' + $(select).attr('name') + '" value="' + $(this).val() + '"';
