...
dsy.add("0_1",["澶╂触甯�"]);
dsy.add("0_2_0",["榛勬郸鍖�","鍗㈡咕鍖�","寰愭眹鍖�","闀垮畞鍖�","闈欏畨鍖�","鏅檧鍖�","闂稿寳鍖�","铏瑰彛鍖�","鏉ㄦ郸鍖�","闂佃鍖�","瀹濆北鍖侯€�","鍢夊畾鍖�","娴︿笢鏂板尯","閲戝北鍖�","鏉炬睙鍖�","闈掓郸鍖�","鍗楁眹鍖�","濂夎搐鍖�","宕囨槑鍘�","鍩庢ˉ闀�"]);
dsy.add("0_2",["涓婃捣甯�"]);
...
dsy.add("0_16_0",["涓師鍖�","浜屼竷鍖�","绠″煄鍥炴棌鍖�","閲戞按鍖�","涓婅鍖�","鎯犳祹鍖侯€�","鏂伴儜甯�","鐧诲皝甯�","鏂板瘑甯�","宸╀箟甯�","鑽ラ槼甯�","涓墴鍘�","鍩庡叧闀�"]);
...
var s=["Province","City","Dist"];//涓変釜select鐨刵ame
var opt0 = ["鐪佷唤","鍦扮骇甯�","甯傘€佸幙绾у競"];//鍒濆鍊�
function _init_area(){  //鍒濆鍖栧嚱鏁�
